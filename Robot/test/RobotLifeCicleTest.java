...
class RobotLifeCicleTest {
    /* Robot buddy = new Robot("buddy", 10); */ Robot buddy;
...
// reset Boolean flag working to false before each test.
    ...
    void init() throws NoSuchFieldException, IllegalAccessException {
        ...
        ((Field) f).setBoolean(buddy, false);
    }
    ...
    void timeoutExceeded() {
        ...
        // execution exceeded timeout of 10 ms by 91 ms assertTimeout(ofMillis(10), () -> { // Simulate task that takes more than 10 ms.
